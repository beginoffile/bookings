...
ALTER TABLE ONLY public.reservation
    ADD CONSTRAINT reservation_room_id_fk FOREIGN KEY (room_id) REFERENCES public.room(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.room_restriction
    ADD CONSTRAINT room_restriction_reservation_id_fk FOREIGN KEY (reservation_id) REFERENCES public.reservation(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.room_restriction
    ADD CONSTRAINT room_restriction_restriction_id_fk FOREIGN KEY (restriction_id) REFERENCES public.restriction(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.room_restriction
    ADD CONSTRAINT room_restriction_room_id_fk FOREIGN KEY (room_id) REFERENCES public.room(id) ON DELETE CASCADE;
